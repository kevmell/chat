...
// Hier werden die Clients aufgelistet. Zuerst wird die Socket-Resource in das Array gepackt.
...
while (true) {
  ...
  if (in_array($socketResource, $newSocketArray)) {
    // Wenn die Socket-Resource im Array enthalten ist, registriere einen neuen Socket-Client
    ...
    // Die Socket-Resource wird aus Array entfernt.
